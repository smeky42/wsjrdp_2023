  ...
  module Export::Pdf::GroupRegistration
    class Groupsheet < Section
      ...
      def render
        ...
        if (@member_count != @approved_member_count )
          bounding_box([0.mm,250.mm], :width => 100.mm, :heigth => 45.mm) do
            text "Deine Gruppe hat #{@member_count} Mitglieder, du hast aber erst #{@approved_member_count} durch Scannen des QR Codes bestätigt. Du kannst die Gruppenanmeldung erst versenden, wenn alle Gruppenmitglieder bestätigt sind.", size: 14
          end
        end
      ...
      def list
        ...
        pdf.move_down 10.mm
        table_data = Array.new
        table_data << ['______________________________', '______________________________' , '______________________________']
